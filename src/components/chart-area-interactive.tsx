...
>
  <ToggleGroupItem
    value="90d"
    className="h-8 min-w-[110px] px-3 text-sm text-center flex items-center justify-center truncate"
  >
    Last 3 months
  </ToggleGroupItem>
  <ToggleGroupItem
          ...
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillDesktop" x1="0" y1="0" x2="0" y2="1">
                <stop
                   offset="0%" stopColor="#60a5fa" stopOpacity={0.7}
                />
                <stop
                  offset="100%" stopColor="#3b82f6" stopOpacity={0.3}
                />
              </linearGradient>
